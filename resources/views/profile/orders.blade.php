                            ...
                            <tr class="h-[100px] border-b">
                                ...
                                <td class="mx-auto text-center px-4">
                                    @switch($order->status)
                                        @case(1)
                                            <span
                                                class="border-2 border-orange-500 py-1 px-3 text-orange-500">{{ $order->getStatus() }}</span>
                                        @break

                                        @case(2)
                                            <span
                                                class="border-2 border-green-500 py-1 px-3 text-green-500">{{ $order->getStatus() }}</span>
                                        @break
                                    @endswitch
                                </td>
                                <td class="text-center align-middle px-4">
