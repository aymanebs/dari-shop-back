...
@section('content')
    ...
    <div class="relative">
        <img class="w-full object-cover brightness-50 filter lg:h-[500px]" src="{{ asset('img/banner2.jpg') }}"
        ...
        <div
            ...
            <h1 class="text-4xl font-bold sm:text-5xl lg:text-left">
              Finest Handcrafted Treasures from Morocco
            </h1>
            <p class="pt-3 text-xs lg:w-3/5 lg:pt-5 lg:text-left lg:text-base">
              Discover exquisite handmade items crafted with love and tradition in Morocco. Each piece tells a
              story of skill, heritage, and culture.
            </p>
            <button
    ...
    <section class="container mx-auto my-8 flex flex-col justify-center gap-3 lg:flex-row">
        ...
        <div class="mx-5 flex flex-row items-center justify-center border-2 border-rose-400 py-4 px-5">
            <div class="">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="h-6 w-6 text-blue-900 lg:mr-2">
      ...
      @foreach ($categories as $key => $category)
          <a href="#" class="flex justify-center items-center">
              <div class="relative cursor-pointer">
                  ...
                  <p class="pointer-events-none absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white lg:text-xl">
                      {{ $category->name }}
                  </p>
              </div>
          </a>
    ...
    <div class="mx-auto max-w-[1200px] px-5">
        <section class="mt-10 flex max-w-[1200px] justify-between bg-blue-900 px-5">
            <div class="py-8 px-3 lg:px-16">
                <p class="text-white">HANDCRAFTED SPECIAL</p>
                <h2 class="pt-6 text-5xl font-bold text-rose-400">15% OFF</h2>
                <p class="pt-4 text-white">
                  HOME DECOR, <br />
                  TEXTILES & MORE
                </p>
                <button href="#" class="mt-6 bg-rose-500 px-4 py-2 duration-100 hover:bg-rose-300">
                    Shop now
                </button>
            </div>

            <img class="-mr-5 hidden w-[550px] object-cover md:block" src="{{ asset('img/laptop_card.jpg') }}"
    ...
    <section class="mx-auto  grid max-w-[1200px] grid-cols-2 gap-3 px-5 pb-10 lg:grid-cols-4">
            ...
            <div class="flex flex-col">
                <div class="relative flex">
                    ...
                    <div
                        class="absolute flex h-full w-full items-center justify-center gap-3 opacity-0 duration-150 hover:opacity-100">
                        <a href="{{ route('product.details', ['product' => $product->id]) }}">
                            <span class="flex h-8 w-8 cursor-pointer items-center justify-center rounded-full bg-rose-500">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="h-4 w-4">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
                    ...
                    <div class="absolute right-1 mt-3 flex items-center justify-center bg-rose-500">
                    ...
                    <div>
                      @if($product->isInStock())
                        <form action="{{ route('cart.store', ['product' => $product->id]) }}" method="POST">
                            @csrf
                            <button type="submit" class="my-5 h-10 w-full bg-blue-900 text-white">
                                Add to cart
                            </button>
                        </form>
                      @endif
        ...
        <div>
          ...
          <div>
            <button class="my-5 h-10 w-full bg-blue-900 text-white">
              Add to cart
            </button>
          </div>
        </div>
