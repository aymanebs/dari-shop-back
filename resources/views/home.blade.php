...
@section('content')
    ...
    <div class="relative">
        <img class="w-full object-cover brightness-50 filter lg:h-[500px]" src="{{ asset('img/header-bg.jpeg') }}"
            ...
            <a href="#">
                <div class="relative cursor-pointer">
                    <img class="mx-auto h-auto w-auto brightness-50 duration-300 hover:brightness-100"
                        src="{{ asset('img/' . $categoryImages[$key]) }}" alt=" cathegory image" />
    ...
    <div class="mx-auto max-w-[1200px] px-5">
        <section class="mt-10 flex max-w-[1200px] justify-between bg-violet-900 px-5">
            ...
            <img class="-mr-5 hidden w-[550px] object-cover md:block" src="{{ asset('img/sale-bage.jpeg') }}"
